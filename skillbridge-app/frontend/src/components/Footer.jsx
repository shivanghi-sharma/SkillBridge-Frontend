...
const Footer = () => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch('/api/auth/register', {
      ...
      body: JSON.stringify({ ...form, password: 'password123', role: 'buyer', skills: [form.skill] }) // Default values for simple signup
    })
      .then(res => res.json())
      .then(data => {
        ...
        if (data.success) {
          ...
          setErrors({ email: data.message || 'Error signing up' });
        }
      })
      .catch(err => {
        setIsSubmitting(false);
