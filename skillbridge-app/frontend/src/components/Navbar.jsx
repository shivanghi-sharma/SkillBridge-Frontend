...
<div className="h-16 md:h-20" ><image src="/skillbridge-app/public/sb_logo.png" alt="Logo" />
</div>
            ...
            <div className="px-4 py-4 space-y-2">
              ...
              <Link to="/login" className="block w-full">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="mt-2 px-5 py-3 text-sm font-semibold rounded-full animated-gradient text-white cursor-pointer"
                >
                  Get Started
                </motion.button>
              </Link>
